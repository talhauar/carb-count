...
public partial class SROptions
{
    ...
    //{
    //    get { return RunTimeDataManager.RTDInstance.IsDebugMode; }
    //    set { RunTimeDataManager.RTDInstance.IsDebugMode = value; }
    //}

    //[DisplayName("Show Rewarded Int Ad")]
    //public void RewardedIntAd()
    //{
    //    AdManager.Instance.ShowAdWithActionCallback(null, AdManager.Instance.New_3Levels, AdManager.AdType.RewardedInterstitial, SessionType.MenuSession);
    //}

    //[DisplayName("Call Adjust Test Event")]
    //public void CallAdjustTestEvent()
    //{
    //    AdjustManager.CallAdjustEvent(AdjustManager.TestEvent);
    //}
